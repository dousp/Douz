...
import com.dsp.douz.rate.limit.guava.conf.LimitProperties;
...
public class RateLimitGuavaProxy implements RateLimitProxy {
    ...
    public Object invoke(ProceedingJoinPoint invocation, String name, String key, int limitPeriod, int limitCount, long timeout) throws Throwable {
        ...
        try {
            ...
            if (this.limitProperties.getExceptionIgnore()) {
        ...
        if (status) {
            ...
            throw new RateLimitGuavaRuntimeException("Reach max limited access count=" + limitCount + " within period=" + limitPeriod + " seconds");
        }
    }
}
